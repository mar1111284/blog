...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "terminal.data";
    var REMOTE_PACKAGE_BASE = "terminal.data";
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_terminal.data");
      }
      Module["addRunDependency"]("datafile_terminal.data");
...
// end include: /tmp/tmplj69dm_2.js
// include: /tmp/tmp9b992tme.js
...
// end include: /tmp/tmp9b992tme.js
// include: /tmp/tmpxg0qsvrc.js
...
// end include: /tmp/tmpxg0qsvrc.js
var arguments_ = [];
...
var syscallGetVarargI = () => {
  ...
  var ret = HEAP32[SAFE_HEAP_INDEX(HEAP32, ((+SYSCALLS.varargs) >>> 2) >>> 0, "loading")];
  SYSCALLS.varargs += 4;
  return ret;
};
...
var SYSCALLS = {
  ...
  writeStat(buf, stat) {
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((buf) >>> 2) >>> 0, "storing")] = stat.dev;
    checkInt32(stat.dev);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (4)) >>> 2) >>> 0, "storing")] = stat.mode;
    checkInt32(stat.mode);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (8)) >>> 2) >>> 0, "storing")] = stat.nlink;
    checkInt32(stat.nlink);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (12)) >>> 2) >>> 0, "storing")] = stat.uid;
    checkInt32(stat.uid);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (16)) >>> 2) >>> 0, "storing")] = stat.gid;
    checkInt32(stat.gid);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (20)) >>> 2) >>> 0, "storing")] = stat.rdev;
    checkInt32(stat.rdev);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (24)) >>> 3) >>> 0, "storing")] = BigInt(stat.size);
    checkInt64(stat.size);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((buf) + (32)) >>> 2) >>> 0, "storing")] = 4096;
    checkInt32(4096);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((buf) + (36)) >>> 2) >>> 0, "storing")] = stat.blocks;
    checkInt32(stat.blocks);
    var atime = stat.atime.getTime();
    var mtime = stat.mtime.getTime();
    var ctime = stat.ctime.getTime();
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (40)) >>> 3) >>> 0, "storing")] = BigInt(Math.floor(atime / 1e3));
    checkInt64(Math.floor(atime / 1e3));
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (48)) >>> 2) >>> 0, "storing")] = (atime % 1e3) * 1e3 * 1e3;
    checkInt32((atime % 1e3) * 1e3 * 1e3);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (56)) >>> 3) >>> 0, "storing")] = BigInt(Math.floor(mtime / 1e3));
    checkInt64(Math.floor(mtime / 1e3));
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (64)) >>> 2) >>> 0, "storing")] = (mtime % 1e3) * 1e3 * 1e3;
    checkInt32((mtime % 1e3) * 1e3 * 1e3);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (72)) >>> 3) >>> 0, "storing")] = BigInt(Math.floor(ctime / 1e3));
    checkInt64(Math.floor(ctime / 1e3));
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (80)) >>> 2) >>> 0, "storing")] = (ctime % 1e3) * 1e3 * 1e3;
    checkInt32((ctime % 1e3) * 1e3 * 1e3);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (88)) >>> 3) >>> 0, "storing")] = BigInt(stat.ino);
    checkInt64(stat.ino);
    return 0;
  },
  writeStatFs(buf, stats) {
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (4)) >>> 2) >>> 0, "storing")] = stats.bsize;
    checkInt32(stats.bsize);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (60)) >>> 2) >>> 0, "storing")] = stats.bsize;
    checkInt32(stats.bsize);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (8)) >>> 3) >>> 0, "storing")] = BigInt(stats.blocks);
    checkInt64(stats.blocks);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (16)) >>> 3) >>> 0, "storing")] = BigInt(stats.bfree);
    checkInt64(stats.bfree);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (24)) >>> 3) >>> 0, "storing")] = BigInt(stats.bavail);
    checkInt64(stats.bavail);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (32)) >>> 3) >>> 0, "storing")] = BigInt(stats.files);
    checkInt64(stats.files);
    HEAP64[SAFE_HEAP_INDEX(HEAP64, (((buf) + (40)) >>> 3) >>> 0, "storing")] = BigInt(stats.ffree);
    checkInt64(stats.ffree);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (48)) >>> 2) >>> 0, "storing")] = stats.fsid;
    checkInt32(stats.fsid);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (64)) >>> 2) >>> 0, "storing")] = stats.flags;
    checkInt32(stats.flags);
    // ST_NOSUID
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((buf) + (56)) >>> 2) >>> 0, "storing")] = stats.namelen;
     ...
     case 12:
      {
        ...
        HEAP16[SAFE_HEAP_INDEX(HEAP16, (((arg) + (offset)) >>> 1) >>> 0, "storing")] = 2;
        checkInt16(2);
        return 0;
      }
     ...
     case 21505:
      {
        ...
        if (stream.tty.ops.ioctl_tcgets) {
          ...
          HEAP32[SAFE_HEAP_INDEX(HEAP32, ((argp) >>> 2) >>> 0, "storing")] = termios.c_iflag || 0;
          checkInt32(termios.c_iflag || 0);
          HEAP32[SAFE_HEAP_INDEX(HEAP32, (((argp) + (4)) >>> 2) >>> 0, "storing")] = termios.c_oflag || 0;
          checkInt32(termios.c_oflag || 0);
          HEAP32[SAFE_HEAP_INDEX(HEAP32, (((argp) + (8)) >>> 2) >>> 0, "storing")] = termios.c_cflag || 0;
          checkInt32(termios.c_cflag || 0);
          HEAP32[SAFE_HEAP_INDEX(HEAP32, (((argp) + (12)) >>> 2) >>> 0, "storing")] = termios.c_lflag || 0;
          checkInt32(termios.c_lflag || 0);
          for (var i = 0; i < 32; i++) {
            HEAP8[SAFE_HEAP_INDEX(HEAP8, (argp + i) + (17) >>> 0, "storing")] = termios.c_cc[i] || 0;
     ...
     case 21508:
      {
        ...
        if (stream.tty.ops.ioctl_tcsets) {
          var argp = syscallGetVarargP();
          var c_iflag = HEAP32[SAFE_HEAP_INDEX(HEAP32, ((argp) >>> 2) >>> 0, "loading")];
          var c_oflag = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((argp) + (4)) >>> 2) >>> 0, "loading")];
          var c_cflag = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((argp) + (8)) >>> 2) >>> 0, "loading")];
          var c_lflag = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((argp) + (12)) >>> 2) >>> 0, "loading")];
          var c_cc = [];
          for (var i = 0; i < 32; i++) {
            c_cc.push(HEAP8[SAFE_HEAP_INDEX(HEAP8, (argp + i) + (17) >>> 0, "loading")]);
          }
     ...
     case 21519:
      {
        if (!stream.tty) return -59;
        var argp = syscallGetVarargP();
        HEAP32[SAFE_HEAP_INDEX(HEAP32, ((argp) >>> 2) >>> 0, "storing")] = 0;
        checkInt32(0);
        return 0;
      }
     ...
     case 21523:
      {
        ...
        if (stream.tty.ops.ioctl_tiocgwinsz) {
          ...
          var argp = syscallGetVarargP();
          HEAP16[SAFE_HEAP_INDEX(HEAP16, ((argp) >>> 1) >>> 0, "storing")] = winsize[0];
          checkInt16(winsize[0]);
          HEAP16[SAFE_HEAP_INDEX(HEAP16, (((argp) + (2)) >>> 1) >>> 0, "storing")] = winsize[1];
...
function __localtime_js(time, tmPtr) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((tmPtr) >>> 2) >>> 0, "storing")] = date.getSeconds();
  checkInt32(date.getSeconds());
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (4)) >>> 2) >>> 0, "storing")] = date.getMinutes();
  checkInt32(date.getMinutes());
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (8)) >>> 2) >>> 0, "storing")] = date.getHours();
  checkInt32(date.getHours());
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (12)) >>> 2) >>> 0, "storing")] = date.getDate();
  checkInt32(date.getDate());
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (16)) >>> 2) >>> 0, "storing")] = date.getMonth();
  checkInt32(date.getMonth());
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (20)) >>> 2) >>> 0, "storing")] = date.getFullYear() - 1900;
  checkInt32(date.getFullYear() - 1900);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (24)) >>> 2) >>> 0, "storing")] = date.getDay();
  checkInt32(date.getDay());
  var yday = ydayFromDate(date) | 0;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (28)) >>> 2) >>> 0, "storing")] = yday;
  checkInt32(yday);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (36)) >>> 2) >>> 0, "storing")] = -(date.getTimezoneOffset() * 60);
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((tmPtr) + (32)) >>> 2) >>> 0, "storing")] = dst;
  checkInt32(dst);
}
...
function __mmap_js(len, prot, flags, fd, offset, allocated, addr) {
  ...
  try {
    ...
    var ptr = res.ptr;
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((allocated) >>> 2) >>> 0, "storing")] = res.allocated;
    checkInt32(res.allocated);
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((addr) >>> 2) >>> 0, "storing")] = ptr;
    return 0;
  } catch (e) {
    if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
    return -e.errno;
...
var Browser = {
  ...
  setFullscreenCanvasSize() {
    ...
    if (typeof SDL != "undefined") {
      var flags = HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((SDL.screen) >>> 2) >>> 0, "loading")];
      flags = flags | 8388608;
      // set SDL_FULLSCREEN flag
      HEAP32[SAFE_HEAP_INDEX(HEAP32, ((SDL.screen) >>> 2) >>> 0, "storing")] = flags;
      checkInt32(flags);
    }
...
var EGL = {
  ...
  chooseConfig(display, attribList, config, config_size, numConfigs) {
    ...
    if (attribList) {
      ...
      for (;;) {
        var param = HEAP32[SAFE_HEAP_INDEX(HEAP32, ((attribList) >>> 2) >>> 0, "loading")];
        if (param == 12321) {
          var alphaSize = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attribList) + (4)) >>> 2) >>> 0, "loading")];
          EGL.contextAttributes.alpha = (alphaSize > 0);
        } else if (param == 12325) {
          var depthSize = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attribList) + (4)) >>> 2) >>> 0, "loading")];
          EGL.contextAttributes.depth = (depthSize > 0);
        } else if (param == 12326) {
          var stencilSize = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attribList) + (4)) >>> 2) >>> 0, "loading")];
          EGL.contextAttributes.stencil = (stencilSize > 0);
        } else if (param == 12337) {
          var samples = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attribList) + (4)) >>> 2) >>> 0, "loading")];
          EGL.contextAttributes.antialias = (samples > 0);
        } else if (param == 12338) {
          var samples = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attribList) + (4)) >>> 2) >>> 0, "loading")];
          EGL.contextAttributes.antialias = (samples == 1);
        } else if (param == 12544) {
          var requestedPriority = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attribList) + (4)) >>> 2) >>> 0, "loading")];
    ...
    if (numConfigs) {
      HEAP32[SAFE_HEAP_INDEX(HEAP32, ((numConfigs) >>> 2) >>> 0, "storing")] = 1;
      checkInt32(1);
    }
    if (config && config_size > 0) {
      HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((config) >>> 2) >>> 0, "storing")] = 62002;
    }
...
var GL = {
  ...
  genObject: (n, buffers, createFunction, objectTable) => {
    for (var i = 0; i < n; i++) {
      ...
      HEAP32[SAFE_HEAP_INDEX(HEAP32, (((buffers) + (i * 4)) >>> 2) >>> 0, "storing")] = id;
      checkInt32(id);
    }
  },
  getSource: (shader, count, string, length) => {
    ...
    for (var i = 0; i < count; ++i) {
      var len = length ? HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((length) + (i * 4)) >>> 2) >>> 0, "loading")] : undefined;
      source += UTF8ToString(HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((string) + (i * 4)) >>> 2) >>> 0, "loading")], len);
    }
    return source;
  },
...
function _eglCreateContext(display, config, hmm, contextAttribs) {
  ...
  for (;;) {
    var param = HEAP32[SAFE_HEAP_INDEX(HEAP32, ((contextAttribs) >>> 2) >>> 0, "loading")];
    if (param == 12440) {
      glesContextVersion = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((contextAttribs) + (4)) >>> 2) >>> 0, "loading")];
    } else if (param == 12344) {
      break;
    } else {
...
function _eglGetConfigAttrib(display, config, attribute, value) {
  ...
  switch (attribute) {
   case 12320:
    // EGL_BUFFER_SIZE
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = EGL.contextAttributes.alpha ? 32 : 24;
    checkInt32(EGL.contextAttributes.alpha ? 32 : 24);
    return 1;

   case 12321:
    // EGL_ALPHA_SIZE
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = EGL.contextAttributes.alpha ? 8 : 0;
    checkInt32(EGL.contextAttributes.alpha ? 8 : 0);
    return 1;

   case 12322:
    // EGL_BLUE_SIZE
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 8;
    checkInt32(8);
    return 1;
   ...
   case 12325:
    // EGL_DEPTH_SIZE
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = EGL.contextAttributes.depth ? 24 : 0;
    checkInt32(EGL.contextAttributes.depth ? 24 : 0);
    return 1;

   case 12326:
    // EGL_STENCIL_SIZE
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = EGL.contextAttributes.stencil ? 8 : 0;
   ...
   case 12327:
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 12344;
    checkInt32(12344);
    return 1;

   case 12328:
    // EGL_CONFIG_ID
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 62002;
    checkInt32(62002);
    return 1;

   case 12329:
    // EGL_LEVEL
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 0;
    checkInt32(0);
    return 1;

   case 12330:
    // EGL_MAX_PBUFFER_HEIGHT
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 4096;
    checkInt32(4096);
    return 1;

   case 12331:
    // EGL_MAX_PBUFFER_PIXELS
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 16777216;
    checkInt32(16777216);
    return 1;
   ...
   case 12337:
    // EGL_SAMPLES
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = EGL.contextAttributes.antialias ? 4 : 0;
    checkInt32(EGL.contextAttributes.antialias ? 4 : 0);
    return 1;

   case 12338:
    // EGL_SAMPLE_BUFFERS
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = EGL.contextAttributes.antialias ? 1 : 0;
    checkInt32(EGL.contextAttributes.antialias ? 1 : 0);
    return 1;

   case 12339:
    // EGL_SURFACE_TYPE
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 4;
    checkInt32(4);
    return 1;
   ...
   // EGL_TRANSPARENT_GREEN_VALUE
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = -1;
    checkInt32(-1);
    return 1;
   ...
   case 12351:
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((value) >>> 2) >>> 0, "storing")] = 12430;
    checkInt32(12430);
    return 1;
...
function _eglInitialize(display, majorVersion, minorVersion) {
  ...
  if (majorVersion) {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((majorVersion) >>> 2) >>> 0, "storing")] = 1;
    checkInt32(1);
  }
  if (minorVersion) {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((minorVersion) >>> 2) >>> 0, "storing")] = 4;
    checkInt32(4);
  }
...
var readEmAsmArgs = (sigPtr, buf) => {
  ...
  // index into HEAP32.
  while (ch = HEAPU8[SAFE_HEAP_INDEX(HEAPU8, sigPtr++ >>> 0, "loading")]) {
    ...
    ch == 112 ? HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((buf) >>> 2) >>> 0, "loading")] : ch == 106 ? HEAP64[SAFE_HEAP_INDEX(HEAP64, ((buf) >>> 3) >>> 0, "loading")] : ch == 105 ? HEAP32[SAFE_HEAP_INDEX(HEAP32, ((buf) >>> 2) >>> 0, "loading")] : HEAPF64[SAFE_HEAP_INDEX(HEAPF64, ((buf) >>> 3) >>> 0, "loading")]);
    buf += wide ? 8 : 4;
  }
...
function _emscripten_get_canvas_element_size(target, width, height) {
  ...
  if (!canvas) return -4;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((width) >>> 2) >>> 0, "storing")] = canvas.width;
  checkInt32(canvas.width);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((height) >>> 2) >>> 0, "storing")] = canvas.height;
...
var getCanvasElementSize = target => {
  ...
  var size = [ HEAP32[SAFE_HEAP_INDEX(HEAP32, ((w) >>> 2) >>> 0, "loading")], HEAP32[SAFE_HEAP_INDEX(HEAP32, ((h) >>> 2) >>> 0, "loading")] ];
  stackRestore(sp);
  return size;
};
...
function _emscripten_get_element_css_size(target, width, height) {
  ...
  if (!target) return -4;
  var rect = getBoundingClientRect(target);
  HEAPF64[SAFE_HEAP_INDEX(HEAPF64, ((width) >>> 3) >>> 0, "storing")] = rect.width;
  HEAPF64[SAFE_HEAP_INDEX(HEAPF64, ((height) >>> 3) >>> 0, "storing")] = rect.height;
  return 0;
}

var fillGamepadEventData = (eventStruct, e) => {
  HEAPF64[SAFE_HEAP_INDEX(HEAPF64, ((eventStruct) >>> 3) >>> 0, "storing")] = e.timestamp;
  for (var i = 0; i < e.axes.length; ++i) {
    HEAPF64[SAFE_HEAP_INDEX(HEAPF64, (((eventStruct + i * 8) + (16)) >>> 3) >>> 0, "storing")] = e.axes[i];
  }
  for (var i = 0; i < e.buttons.length; ++i) {
    if (typeof e.buttons[i] == "object") {
      HEAPF64[SAFE_HEAP_INDEX(HEAPF64, (((eventStruct + i * 8) + (528)) >>> 3) >>> 0, "storing")] = e.buttons[i].value;
    } else {
      HEAPF64[SAFE_HEAP_INDEX(HEAPF64, (((eventStruct + i * 8) + (528)) >>> 3) >>> 0, "storing")] = e.buttons[i];
    }
  }
  for (var i = 0; i < e.buttons.length; ++i) {
    if (typeof e.buttons[i] == "object") {
      HEAP8[SAFE_HEAP_INDEX(HEAP8, (eventStruct + i) + (1040) >>> 0, "storing")] = e.buttons[i].pressed;
      checkInt8(e.buttons[i].pressed);
    } else {
      // Assigning a boolean to HEAP32, that's ok, but Closure would like to warn about it:
      /** @suppress {checkTypes} */ HEAP8[SAFE_HEAP_INDEX(HEAP8, (eventStruct + i) + (1040) >>> 0, "storing")] = e.buttons[i] == 1;
      checkInt8(e.buttons[i] == 1);
    }
  }
  HEAP8[SAFE_HEAP_INDEX(HEAP8, (eventStruct) + (1104) >>> 0, "storing")] = e.connected;
  checkInt8(e.connected);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (1108)) >>> 2) >>> 0, "storing")] = e.index;
  checkInt32(e.index);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (8)) >>> 2) >>> 0, "storing")] = e.axes.length;
  checkInt32(e.axes.length);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (12)) >>> 2) >>> 0, "storing")] = e.buttons.length;
...
function _emscripten_get_screen_size(width, height) {
  width >>>= 0;
  height >>>= 0;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((width) >>> 2) >>> 0, "storing")] = screen.width;
  checkInt32(screen.width);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((height) >>> 2) >>> 0, "storing")] = screen.height;
...
function _emscripten_glDeleteBuffers(n, buffers) {
  buffers >>>= 0;
  for (var i = 0; i < n; i++) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((buffers) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDeleteFramebuffers(n, framebuffers) {
  framebuffers >>>= 0;
  for (var i = 0; i < n; ++i) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((framebuffers) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDeleteQueries(n, ids) {
  ids >>>= 0;
  for (var i = 0; i < n; i++) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((ids) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDeleteRenderbuffers(n, renderbuffers) {
  renderbuffers >>>= 0;
  for (var i = 0; i < n; i++) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((renderbuffers) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDeleteSamplers(n, samplers) {
  samplers >>>= 0;
  for (var i = 0; i < n; i++) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((samplers) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDeleteTextures(n, textures) {
  textures >>>= 0;
  for (var i = 0; i < n; i++) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((textures) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDeleteVertexArrays(n, vaos) {
  vaos >>>= 0;
  for (var i = 0; i < n; i++) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((vaos) + (i * 4)) >>> 2) >>> 0, "loading")];
...
function _emscripten_glDrawBuffers(n, bufs) {
  ...
  for (var i = 0; i < n; i++) {
    bufArray[i] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((bufs) + (i * 4)) >>> 2) >>> 0, "loading")];
  }
...
function _emscripten_glGenQueriesEXT(n, ids) {
  ...
  for (var i = 0; i < n; i++) {
    ...
    if (!query) {
      GL.recordError(1282);
      while (i < n) HEAP32[SAFE_HEAP_INDEX(HEAP32, (((ids) + (i++ * 4)) >>> 2) >>> 0, "storing")] = 0;
      checkInt32(0);
      return;
    }
    ...
    query.name = id;
    GL.queries[id] = query;
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((ids) + (i * 4)) >>> 2) >>> 0, "storing")] = id;
    checkInt32(id);
  }
}
...
var __glGetActiveAttribOrUniform = (funcName, program, index, bufSize, length, size, type, name) => {
  ...
  if (info) {
    ...
    if (length) HEAP32[SAFE_HEAP_INDEX(HEAP32, ((length) >>> 2) >>> 0, "storing")] = numBytesWrittenExclNull;
    checkInt32(numBytesWrittenExclNull);
    if (size) HEAP32[SAFE_HEAP_INDEX(HEAP32, ((size) >>> 2) >>> 0, "storing")] = info.size;
    checkInt32(info.size);
    if (type) HEAP32[SAFE_HEAP_INDEX(HEAP32, ((type) >>> 2) >>> 0, "storing")] = info.type;
...
function _emscripten_glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize, length, uniformBlockName) {
  ...
  if (uniformBlockName && bufSize > 0) {
    ...
    if (length) HEAP32[SAFE_HEAP_INDEX(HEAP32, ((length) >>> 2) >>> 0, "storing")] = 0;
    checkInt32(0);
  }
}
...
function _emscripten_glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params) {
  ...
  if (pname == 35393) {
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = name.length + 1;
  ...
  if (pname == 35395) {
    for (var i = 0; i < result.length; i++) {
      HEAP32[SAFE_HEAP_INDEX(HEAP32, (((params) + (i * 4)) >>> 2) >>> 0, "storing")] = result[i];
      checkInt32(result[i]);
    }
  } else {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = result;
    checkInt32(result);
  }
}
...
function _emscripten_glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params) {
  ...
  for (var i = 0; i < uniformCount; i++) {
    ids.push(HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uniformIndices) + (i * 4)) >>> 2) >>> 0, "loading")]);
  }
...
function _emscripten_glGetAttachedShaders(program, maxCount, count, shaders) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((count) >>> 2) >>> 0, "storing")] = len;
  checkInt32(len);
  for (var i = 0; i < len; ++i) {
    var id = GL.shaders.indexOf(result[i]);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((shaders) + (i * 4)) >>> 2) >>> 0, "storing")] = id;
    checkInt32(id);
  }
}
...
var readI53FromI64 = ptr => HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((ptr) >>> 2) >>> 0, "loading")] + HEAP32[SAFE_HEAP_INDEX(HEAP32, (((ptr) + (4)) >>> 2) >>> 0, "loading")] * 4294967296;

var readI53FromU64 = ptr => HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((ptr) >>> 2) >>> 0, "loading")] + HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((ptr) + (4)) >>> 2) >>> 0, "loading")] * 4294967296;

var writeI53ToI64 = (ptr, num) => {
  HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((ptr) >>> 2) >>> 0, "storing")] = num;
  checkInt32(num);
  var lower = HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((ptr) >>> 2) >>> 0, "loading")];
  HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((ptr) + (4)) >>> 2) >>> 0, "storing")] = (num - lower) / 4294967296;
  checkInt32((num - lower) / 4294967296);
  var deserialized = (num >= 0) ? readI53FromU64(ptr) : readI53FromI64(ptr);
  var offset = ((ptr) >>> 2);
  if (deserialized != num) warnOnce(`writeI53ToI64() out of range: serialized JS Number ${num} to Wasm heap as bytes lo=${ptrToString(HEAPU32[SAFE_HEAP_INDEX(HEAPU32, offset >>> 0, "loading")])}, hi=${ptrToString(HEAPU32[SAFE_HEAP_INDEX(HEAPU32, offset + 1 >>> 0, "loading")])}, which deserializes back to ${deserialized} instead!`);
};
...
var emscriptenWebGLGet = (name_, p, type) => {
     ...
     case "object":
      if (result === null) {
        ...
        for (var i = 0; i < result.length; ++i) {
          switch (type) {
           case 0:
            HEAP32[SAFE_HEAP_INDEX(HEAP32, (((p) + (i * 4)) >>> 2) >>> 0, "storing")] = result[i];
            checkInt32(result[i]);
            break;

           case 2:
            HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((p) + (i * 4)) >>> 2) >>> 0, "storing")] = result[i];
            break;

           case 4:
            HEAP8[SAFE_HEAP_INDEX(HEAP8, (p) + (i) >>> 0, "storing")] = result[i] ? 1 : 0;
  ...
  switch (type) {
   ...
   case 0:
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = ret;
    checkInt32(ret);
    break;

   case 2:
    HEAPF32[SAFE_HEAP_INDEX(HEAPF32, ((p) >>> 2) >>> 0, "storing")] = ret;
    break;

   case 4:
    HEAP8[SAFE_HEAP_INDEX(HEAP8, p >>> 0, "storing")] = ret ? 1 : 0;
    checkInt8(ret ? 1 : 0);
    break;
  }
};
...
function _emscripten_glGetBufferParameteriv(target, value, data) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((data) >>> 2) >>> 0, "storing")] = GLctx.getBufferParameter(target, value);
...
var emscriptenWebGLGetIndexed = (target, index, data, type) => {
  ...
  switch (type) {
   ...
   case 0:
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((data) >>> 2) >>> 0, "storing")] = ret;
    checkInt32(ret);
    break;

   case 2:
    HEAPF32[SAFE_HEAP_INDEX(HEAPF32, ((data) >>> 2) >>> 0, "storing")] = ret;
    break;

   case 4:
    HEAP8[SAFE_HEAP_INDEX(HEAP8, data >>> 0, "storing")] = ret ? 1 : 0;
    checkInt8(ret ? 1 : 0);
    break;
...
function _emscripten_glGetInternalformativ(target, internalformat, pname, bufSize, params) {
  ...
  for (var i = 0; i < ret.length && i < bufSize; ++i) {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((params) + (i * 4)) >>> 2) >>> 0, "storing")] = ret[i];
    checkInt32(ret[i]);
  }
}
...
function _emscripten_glGetProgramiv(program, pname, p) {
  ...
  if (pname == 35716) {
    ...
    if (log === null) log = "(unknown error)";
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = log.length + 1;
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = program.maxUniformLength;
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = program.maxAttributeLength;
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = program.maxUniformBlockNameLength;
    checkInt32(program.maxUniformBlockNameLength);
  } else {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = GLctx.getProgramParameter(program, pname);
...
function _emscripten_glGetQueryObjectivEXT(id, pname, params) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = ret;
  checkInt32(ret);
}
...
function _emscripten_glGetQueryiv(target, pname, params) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = GLctx.getQuery(target, pname);
...
function _emscripten_glGetQueryivEXT(target, pname, params) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = GLctx.disjointTimerQueryExt["getQueryEXT"](target, pname);
...
function _emscripten_glGetRenderbufferParameteriv(target, pname, params) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = GLctx.getRenderbufferParameter(target, pname);
...
function _emscripten_glGetSamplerParameterfv(sampler, pname, params) {
  ...
  HEAPF32[SAFE_HEAP_INDEX(HEAPF32, ((params) >>> 2) >>> 0, "storing")] = GLctx.getSamplerParameter(GL.samplers[sampler], pname);
}
...
function _emscripten_glGetSamplerParameteriv(sampler, pname, params) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = GLctx.getSamplerParameter(GL.samplers[sampler], pname);
...
function _emscripten_glGetShaderPrecisionFormat(shaderType, precisionType, range, precision) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((range) >>> 2) >>> 0, "storing")] = result.rangeMin;
  checkInt32(result.rangeMin);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((range) + (4)) >>> 2) >>> 0, "storing")] = result.rangeMax;
  checkInt32(result.rangeMax);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((precision) >>> 2) >>> 0, "storing")] = result.precision;
...
function _emscripten_glGetShaderiv(shader, pname, p) {
  ...
  if (pname == 35716) {
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = logLength;
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = sourceLength;
    checkInt32(sourceLength);
  } else {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((p) >>> 2) >>> 0, "storing")] = GLctx.getShaderParameter(GL.shaders[shader], pname);
...
function _emscripten_glGetSynciv(sync, pname, bufSize, length, values) {
  ...
  if (ret !== null) {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((values) >>> 2) >>> 0, "storing")] = ret;
    checkInt32(ret);
    if (length) HEAP32[SAFE_HEAP_INDEX(HEAP32, ((length) >>> 2) >>> 0, "storing")] = 1;
    checkInt32(1);
  }
}
...
function _emscripten_glGetTexParameterfv(target, pname, params) {
  ...
  HEAPF32[SAFE_HEAP_INDEX(HEAPF32, ((params) >>> 2) >>> 0, "storing")] = GLctx.getTexParameter(target, pname);
}
...
function _emscripten_glGetTexParameteriv(target, pname, params) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = GLctx.getTexParameter(target, pname);
...
function _emscripten_glGetUniformIndices(program, uniformCount, uniformNames, uniformIndices) {
  ...
  program = GL.programs[program];
  var names = [];
  for (var i = 0; i < uniformCount; i++) names.push(UTF8ToString(HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((uniformNames) + (i * 4)) >>> 2) >>> 0, "loading")]));
  var result = GLctx.getUniformIndices(program, names);
  if (!result) return;
  // GL spec: If an error is generated, nothing is written out to uniformIndices.
  var len = result.length;
  for (var i = 0; i < len; i++) {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uniformIndices) + (i * 4)) >>> 2) >>> 0, "storing")] = result[i];
    checkInt32(result[i]);
  }
}
...
/** @suppress{checkTypes} */ var emscriptenWebGLGetUniform = (program, location, params, type) => {
  ...
  if (typeof data == "number" || typeof data == "boolean") {
    switch (type) {
     case 0:
      HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = data;
      checkInt32(data);
      break;

     case 2:
      HEAPF32[SAFE_HEAP_INDEX(HEAPF32, ((params) >>> 2) >>> 0, "storing")] = data;
      break;
    }
  } else {
    for (var i = 0; i < data.length; i++) {
      switch (type) {
       case 0:
        HEAP32[SAFE_HEAP_INDEX(HEAP32, (((params) + (i * 4)) >>> 2) >>> 0, "storing")] = data[i];
        checkInt32(data[i]);
        break;

       case 2:
        HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((params) + (i * 4)) >>> 2) >>> 0, "storing")] = data[i];
        break;
      }
    }
  }
...
/** @suppress{checkTypes} */ var emscriptenWebGLGetVertexAttrib = (index, pname, params, type) => {
  ...
  if (pname == 34975) {
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = data && data["name"];
    ...
    switch (type) {
     ...
     case 5:
      HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "storing")] = Math.fround(data);
    ...
    for (var i = 0; i < data.length; i++) {
      switch (type) {
       ...
       case 5:
        HEAP32[SAFE_HEAP_INDEX(HEAP32, (((params) + (i * 4)) >>> 2) >>> 0, "storing")] = Math.fround(data[i]);
...
function _emscripten_glGetVertexAttribPointerv(index, pname, pointer) {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, ((pointer) >>> 2) >>> 0, "storing")] = GLctx.getVertexAttribOffset(index, pname);
...
function _emscripten_glInvalidateFramebuffer(target, numAttachments, attachments) {
  ...
  for (var i = 0; i < numAttachments; i++) {
    list[i] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((attachments) + (i * 4)) >>> 2) >>> 0, "loading")];
  }
...
function _emscripten_glSamplerParameterfv(sampler, pname, params) {
  params >>>= 0;
  var param = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, ((params) >>> 2) >>> 0, "loading")];
  GLctx.samplerParameterf(GL.samplers[sampler], pname, param);
}
...
function _emscripten_glSamplerParameteriv(sampler, pname, params) {
  params >>>= 0;
  var param = HEAP32[SAFE_HEAP_INDEX(HEAP32, ((params) >>> 2) >>> 0, "loading")];
  GLctx.samplerParameteri(GL.samplers[sampler], pname, param);
}
...
function _emscripten_glTransformFeedbackVaryings(program, count, varyings, bufferMode) {
  ...
  program = GL.programs[program];
  var vars = [];
  for (var i = 0; i < count; i++) vars.push(UTF8ToString(HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((varyings) + (i * 4)) >>> 2) >>> 0, "loading")]));
...
function _emscripten_glUniform1fv(location, count, value) {
  ...
  if (count <= 288) {
    ...
    for (var i = 0; i < count; ++i) {
      view[i] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniform1iv(location, count, value) {
  ...
  if (count <= 288) {
    ...
    for (var i = 0; i < count; ++i) {
      view[i] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniform2fv(location, count, value) {
  ...
  if (count <= 144) {
    ...
    for (var i = 0; i < count; i += 2) {
      view[i] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i)) >>> 2) >>> 0, "loading")];
      view[i + 1] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 4)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniform2iv(location, count, value) {
  ...
  if (count <= 144) {
    ...
    for (var i = 0; i < count; i += 2) {
      view[i] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i)) >>> 2) >>> 0, "loading")];
      view[i + 1] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i + 4)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniform3fv(location, count, value) {
  ...
  if (count <= 96) {
    ...
    for (var i = 0; i < count; i += 3) {
      view[i] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i)) >>> 2) >>> 0, "loading")];
      view[i + 1] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 4)) >>> 2) >>> 0, "loading")];
      view[i + 2] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 8)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniform3iv(location, count, value) {
  ...
  if (count <= 96) {
    ...
    for (var i = 0; i < count; i += 3) {
      view[i] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i)) >>> 2) >>> 0, "loading")];
      view[i + 1] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i + 4)) >>> 2) >>> 0, "loading")];
      view[i + 2] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i + 8)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniform4iv(location, count, value) {
  ...
  if (count <= 72) {
    ...
    for (var i = 0; i < count; i += 4) {
      ...
      view[i + 1] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i + 4)) >>> 2) >>> 0, "loading")];
      view[i + 2] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i + 8)) >>> 2) >>> 0, "loading")];
      view[i + 3] = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((value) + (4 * i + 12)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_glUniformMatrix2fv(location, count, transpose, value) {
  ...
  if (count <= 72) {
    ...
    for (var i = 0; i < count; i += 4) {
      ...
      view[i + 1] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 4)) >>> 2) >>> 0, "loading")];
      view[i + 2] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 8)) >>> 2) >>> 0, "loading")];
      view[i + 3] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 12)) >>> 2) >>> 0, "loading")];
    }
  } else {
    var view = HEAPF32.subarray((((value) >>> 2)) >>> 0, ((value + count * 16) >>> 2) >>> 0);
  }
...
function _emscripten_glUniformMatrix3fv(location, count, transpose, value) {
  ...
  if (count <= 32) {
    ...
    for (var i = 0; i < count; i += 9) {
      ...
      view[i + 2] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 8)) >>> 2) >>> 0, "loading")];
      view[i + 3] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 12)) >>> 2) >>> 0, "loading")];
      view[i + 4] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 16)) >>> 2) >>> 0, "loading")];
      view[i + 5] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 20)) >>> 2) >>> 0, "loading")];
      view[i + 6] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 24)) >>> 2) >>> 0, "loading")];
      view[i + 7] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 28)) >>> 2) >>> 0, "loading")];
      view[i + 8] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, (((value) + (4 * i + 32)) >>> 2) >>> 0, "loading")];
    }
  } else {
...
function _emscripten_request_fullscreen_strategy(target, deferUntilInEventHandler, fullscreenStrategy) {
  ...
  var strategy = {
    scaleMode: HEAP32[SAFE_HEAP_INDEX(HEAP32, ((fullscreenStrategy) >>> 2) >>> 0, "loading")],
    canvasResolutionScaleMode: HEAP32[SAFE_HEAP_INDEX(HEAP32, (((fullscreenStrategy) + (4)) >>> 2) >>> 0, "loading")],
    filteringMode: HEAP32[SAFE_HEAP_INDEX(HEAP32, (((fullscreenStrategy) + (8)) >>> 2) >>> 0, "loading")],
    deferUntilInEventHandler,
    canvasResizedCallback: HEAP32[SAFE_HEAP_INDEX(HEAP32, (((fullscreenStrategy) + (12)) >>> 2) >>> 0, "loading")],
    canvasResizedCallbackUserData: HEAP32[SAFE_HEAP_INDEX(HEAP32, (((fullscreenStrategy) + (16)) >>> 2) >>> 0, "loading")]
  };
...
var fillFullscreenChangeEventData = eventStruct => {
  ...
  /** @suppress{checkTypes} */ HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct >>> 0, "storing")] = isFullscreen;
  checkInt8(isFullscreen);
  HEAP8[SAFE_HEAP_INDEX(HEAP8, (eventStruct) + (1) >>> 0, "storing")] = JSEvents.fullscreenEnabled();
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (260)) >>> 2) >>> 0, "storing")] = reportedElement ? reportedElement.clientWidth : 0;
  checkInt32(reportedElement ? reportedElement.clientWidth : 0);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (264)) >>> 2) >>> 0, "storing")] = reportedElement ? reportedElement.clientHeight : 0;
  checkInt32(reportedElement ? reportedElement.clientHeight : 0);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (268)) >>> 2) >>> 0, "storing")] = screen.width;
  checkInt32(screen.width);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (272)) >>> 2) >>> 0, "storing")] = screen.height;
  checkInt32(screen.height);
  if (isFullscreen) {
...
var registerKeyEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
  ...
  var keyEventHandlerFunc = e => {
    ...
    HEAPF64[SAFE_HEAP_INDEX(HEAPF64, ((keyEventData) >>> 3) >>> 0, "storing")] = e.timeStamp;
    var idx = ((keyEventData) >>> 2);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 2 >>> 0, "storing")] = e.location;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, keyEventData + 12 >>> 0, "storing")] = e.ctrlKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, keyEventData + 13 >>> 0, "storing")] = e.shiftKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, keyEventData + 14 >>> 0, "storing")] = e.altKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, keyEventData + 15 >>> 0, "storing")] = e.metaKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, keyEventData + 16 >>> 0, "storing")] = e.repeat;
    HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 5 >>> 0, "storing")] = e.charCode;
    HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 6 >>> 0, "storing")] = e.keyCode;
    HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 7 >>> 0, "storing")] = e.which;
...
var fillMouseEventData = (eventStruct, e, target) => {
  ...
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 2 >>> 0, "storing")] = e.screenX;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 3 >>> 0, "storing")] = e.screenY;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 4 >>> 0, "storing")] = e.clientX;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 5 >>> 0, "storing")] = e.clientY;
  HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct + 24 >>> 0, "storing")] = e.ctrlKey;
  HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct + 25 >>> 0, "storing")] = e.shiftKey;
  HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct + 26 >>> 0, "storing")] = e.altKey;
  HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct + 27 >>> 0, "storing")] = e.metaKey;
  HEAP16[SAFE_HEAP_INDEX(HEAP16, idx * 2 + 14 >>> 0, "storing")] = e.button;
  HEAP16[SAFE_HEAP_INDEX(HEAP16, idx * 2 + 15 >>> 0, "storing")] = e.buttons;
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 8 >>> 0, "storing")] = e["movementX"];
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 9 >>> 0, "storing")] = e["movementY"];
  // Note: rect contains doubles (truncated to placate SAFE_HEAP, which is the same behaviour when writing to HEAP32 anyway)
  var rect = getBoundingClientRect(target);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 10 >>> 0, "storing")] = e.clientX - (rect.left | 0);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, idx + 11 >>> 0, "storing")] = e.clientY - (rect.top | 0);
};
...
var fillPointerlockChangeEventData = eventStruct => {
  ...
  // Assigning a boolean to HEAP32 with expected type coercion.
  /** @suppress{checkTypes} */ HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct >>> 0, "storing")] = isPointerlocked;
...
var registerUiEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
  ...
  var uiEventHandlerFunc = e => {
    ...
    HEAP32[SAFE_HEAP_INDEX(HEAP32, ((uiEvent) >>> 2) >>> 0, "storing")] = 0;
    checkInt32(0);
    // always zero for resize and scroll
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (4)) >>> 2) >>> 0, "storing")] = b.clientWidth;
    checkInt32(b.clientWidth);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (8)) >>> 2) >>> 0, "storing")] = b.clientHeight;
    checkInt32(b.clientHeight);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (12)) >>> 2) >>> 0, "storing")] = innerWidth;
    checkInt32(innerWidth);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (16)) >>> 2) >>> 0, "storing")] = innerHeight;
    checkInt32(innerHeight);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (20)) >>> 2) >>> 0, "storing")] = outerWidth;
    checkInt32(outerWidth);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (24)) >>> 2) >>> 0, "storing")] = outerHeight;
    checkInt32(outerHeight);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (28)) >>> 2) >>> 0, "storing")] = pageXOffset | 0;
    checkInt32(pageXOffset | 0);
    // scroll offsets are float
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((uiEvent) + (32)) >>> 2) >>> 0, "storing")] = pageYOffset | 0;
...
var registerTouchEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
  ...
  var touchEventHandlerFunc = e => {
    ...
    HEAPF64[SAFE_HEAP_INDEX(HEAPF64, ((touchEvent) >>> 3) >>> 0, "storing")] = e.timeStamp;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, touchEvent + 12 >>> 0, "storing")] = e.ctrlKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, touchEvent + 13 >>> 0, "storing")] = e.shiftKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, touchEvent + 14 >>> 0, "storing")] = e.altKey;
    HEAP8[SAFE_HEAP_INDEX(HEAP8, touchEvent + 15 >>> 0, "storing")] = e.metaKey;
    ...
    for (let t of Object.values(touches)) {
      ...
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 0 >>> 0, "storing")] = t.identifier;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 1 >>> 0, "storing")] = t.screenX;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 2 >>> 0, "storing")] = t.screenY;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 3 >>> 0, "storing")] = t.clientX;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 4 >>> 0, "storing")] = t.clientY;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 5 >>> 0, "storing")] = t.pageX;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 6 >>> 0, "storing")] = t.pageY;
      HEAP8[SAFE_HEAP_INDEX(HEAP8, idx + 28 >>> 0, "storing")] = t.isChanged;
      HEAP8[SAFE_HEAP_INDEX(HEAP8, idx + 29 >>> 0, "storing")] = t.onTarget;
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 8 >>> 0, "storing")] = t.clientX - (targetRect.left | 0);
      HEAP32[SAFE_HEAP_INDEX(HEAP32, idx32 + 9 >>> 0, "storing")] = t.clientY - (targetRect.top | 0);
      idx += 48;
      if (++numTouches > 31) {
        break;
      }
    }
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((touchEvent) + (8)) >>> 2) >>> 0, "storing")] = numTouches;
...
var fillVisibilityChangeEventData = eventStruct => {
  ...
  // Assigning a boolean to HEAP32 with expected type coercion.
  /** @suppress{checkTypes} */ HEAP8[SAFE_HEAP_INDEX(HEAP8, eventStruct >>> 0, "storing")] = document.hidden;
  checkInt8(document.hidden);
  HEAP32[SAFE_HEAP_INDEX(HEAP32, (((eventStruct) + (4)) >>> 2) >>> 0, "storing")] = visibilityState;
...
var registerWheelEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
  ...
  var wheelHandlerFunc = e => {
    ...
    HEAPF64[SAFE_HEAP_INDEX(HEAPF64, (((wheelEvent) + (64)) >>> 3) >>> 0, "storing")] = e["deltaX"];
    HEAPF64[SAFE_HEAP_INDEX(HEAPF64, (((wheelEvent) + (72)) >>> 3) >>> 0, "storing")] = e["deltaY"];
    HEAPF64[SAFE_HEAP_INDEX(HEAPF64, (((wheelEvent) + (80)) >>> 3) >>> 0, "storing")] = e["deltaZ"];
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((wheelEvent) + (88)) >>> 2) >>> 0, "storing")] = e["deltaMode"];
...
function _fd_seek(fd, offset, whence, newOffset) {
  ...
  try {
    ...
    HEAP64[SAFE_HEAP_INDEX(HEAP64, ((newOffset) >>> 3) >>> 0, "storing")] = BigInt(stream.position);
...
var ASM_CONSTS = {
  1383256: () => window.innerWidth,
  1383286: () => window.innerHeight,
  1383317: $0 => {
  ...
  1390718: ($0, $1) => {
    ...
    for (var c = 0; c < numChannels; ++c) {
      ...
      for (var j = 0; j < $1; ++j) {
        channelData[j] = HEAPF32[SAFE_HEAP_INDEX(HEAPF32, buf + (j * numChannels + c) >>> 0, "loading")];
      }
    }
  },
  1391207: $0 => {
  ...
  1392213: ($0, $1, $2) => {
    ...
    if (typeof CanvasPixelArray !== "undefined" && data instanceof CanvasPixelArray) {
      num = data.length;
      while (dst < num) {
        var val = HEAP32[SAFE_HEAP_INDEX(HEAP32, src >>> 0, "loading")];
        data[dst] = val & 255;
  ...
  1394819: () => window.innerWidth,
  1394849: () => window.innerHeight
};
