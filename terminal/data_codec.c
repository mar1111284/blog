...
ManEntry man_db[] = {
    ...
    },
	{
		...
		"  ramp=<1-4>       ASCII character ramp preset. Default: 1\n\n"
		"ASCII Ramp Presets:\n"
		"  ramp=1  Wide tonal range\n"
		"          Smooth gradients and rich shading.\n"
		"          Best for photos and detailed images.\n\n"
		"  ramp=2  High contrast\n"
		"          Bold shapes with strong separation.\n"
		"          Ideal for logos, symbols, and graphic art.\n\n"
		"  ramp=3  Monospace optimized\n"
		"          Designed for terminal display.\n"
		"          Clean, readable, and stable spacing.\n\n"
		"  ramp=4  Unicode enhanced\n"
		"          Uses block characters for maximum fidelity.\n"
		"          Best visual quality, requires Unicode support.\n\n"
		"Examples:\n"
		"  to_ascii https://i.imgur.com/example.jpg\n"
		"  to_ascii https://picsum.photos/800/600 ramp=2\n"
		"  to_ascii https://picsum.photos/800/600 download=1 ramp=4 wide=300 font_size=15\n\n"
		"Notes:\n"
		...
		"  - Unicode ramps may not render correctly in all terminals.\n\n"
		"Image Tips:\n"
